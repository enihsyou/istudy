# Generated by Django 2.0 on 2017-12-22 02:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(max_length=255, verbose_name='问题主体')),
                ('answer', models.CharField(max_length=255, verbose_name='问题答案')),
                ('last_modification', models.DateTimeField(auto_now=True, verbose_name='最后更新时间')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '教师',
                'permissions': (('create_course', '创建课程'),),
            },
        ),
        migrations.AddField(
            model_name='student',
