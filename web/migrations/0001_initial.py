    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Paper')),
            ],
            options={
                'verbose_name': '试卷问题',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_uid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Course', verbose_name='课程id')),
                ('student_uid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Student', verbose_name='学生id')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
